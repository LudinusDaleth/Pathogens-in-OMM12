...
#setwd("G:/My Drive/downstream/monica/paper_selection")
...
ps2 <- subset_samples(ps2, mouse_microbiome == "SPF")
...
custom_labels <- c("Akkermansiaceae(Verrucomicrobiales)" = "Akkermansiaceae",
                   "Bacteroidaceae(Bacteroidales)" = "Bacteroidaceae",
                   "Lachnospiraceae(Clostridiales)" = "Lachnospiraceae",
                   "Muribaculaceae(Bacteroidales)" = "Muribaculaceae",
                   "Ruminococcaceae(Clostridiales)" = "Ruminococcaceae",
                   "Bifidobacteriaceae(Bifidobacteriales)" = "Bifidobacteriaceae",
                   "Rikenellaceae(Bacteroidales)" = "Rikenellaceae",
                   "Prevotellaceae(Bacteroidales)" = "Prevotellaceae",
                   "NA(Bacteroidales)" = "Unlcassified (Bacteroidales)",
                   "NA(Clostridiales)" = "Unlcassified (Clostridiales)"
)
...
# Saving the plot
ggsave("plots/combined_genus_avg_spf.png", width = 8, height = 4, dpi = 500)
